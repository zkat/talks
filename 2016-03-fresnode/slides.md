...
Get the slides! npm install @zkat/sfnode-2015
...
Why does this all matter? Because npm relies on you using semver correctly when you publish your packages. You can read the whole semver spec over at semver.org if you want more details.
...
Recently, npm released one of its newest products: Organizations.
...
The feature is already implemented CLI. It's also in beta! If you’re interested in trying it out and helping us test during our beta, check out the link on the slide.
...
That's it! it's an exciting time to be working on this stuff. I look forward to where things move in the future, and I hope you all enjoy using this tool that I have the privilege to work on.
